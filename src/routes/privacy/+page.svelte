...
<section class="bg-white dark:bg-gray-900">
	<div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
		...
		<p class="font-light text-gray-500 md:text-sm xl:text-xl dark:text-gray-400">

		PRIVACY POLICY
		Last updated April 05, 2025
		</p>

		<p class="font-light text-justify text-gray-500 md:text-sm xl:text-xl dark:text-gray-400">
		...
		<p class="font-light text-justify text-gray-500 md:text-sm xl:text-xl dark:text-gray-400">
				...
				<p class="font-light text-justify text-gray-500 md:text-sm xl:text-xl dark:text-gray-400">				NO
				</p>

				<p class="font-light text-justify text-gray-500 md:text-sm xl:text-xl dark:text-gray-400">				C. Protected classification characteristics under state or federal law
