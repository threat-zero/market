...
<section class="bg-white dark:bg-gray-900">
	...
	-->
		<h1
			class="mb-4 text-2xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-2xl xl:text-3xl dark:text-white"
		>
			We take Privacy Seriously
		</h1>

		<p class="font-light text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
		...
		<p class="font-medium text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
				...
				<p class="font-light text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
				How do you exercise your rights? The easiest way to exercise your rights is by visiting threatmatic.com/privacy, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
				</p>
		...
		<p class="font-medium text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
				...
				<p class="font-light text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">				NO
				</p>

				<p class="font-light text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">				C. Protected classification characteristics under state or federal law
			...
			<p class="font-light text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
				...
				<p class="font-light text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
					To exercise these rights, you can contact us by visiting threatmatic.com/privacy, by emailing us at privacy@threatmatic.com, or by referring to the contact details at the bottom of this document.
				</p>
				...
				<p class="font-light text-justify text-gray-500 md:text-lg xl:text-sm dark:text-gray-400">
					If you have questions or comments about this notice, you may email us at privacy@threatmatic.com or contact us by post at:
				</p>
