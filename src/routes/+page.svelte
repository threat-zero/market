...
<FeaturesList
	featureData={{
		...
		'Take Control of Your Bandwidth': [
			{
				name: 'Free Up Your Bandwidth',
				description: 'Manage network bandwidth to prevent bandwidth-starving software updates.',
		...
		'Secure Your Network': [
			{
				name: 'Inbound Access Control',
				description: 'Orchestrate inbound access rules directly on all your endpoints.',
				flowbiteIconName: 'sort-horizontal-solid'
			},
			{
				name: 'Precise Traffic Monitoring',
				description:
					'Track and alert on specific traffic streams from executables to specific destinations and ports.',
				flowbiteIconName: 'search-solid'
			},
			{
		...
		'Defense-in-Depth': [
			{
				...
				flowbiteIconName: 'brain-solid'
			},
			{
				name: 'Browser DNS-over-HTTP Control',
				description: 'Control DNS-over-HTTP for individual browsers by user, group, or device.',
				flowbiteIconName: 'draw-square-solid'
			},
			{
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLScTMV_GyN480Jie4voJMwDDb6U6WUv14p0k8do3TPeeb8g9uQ/viewform?usp=sf_link" target="_blank"
								rel="external noopener noreferrer" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Get started
                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                    </svg>
                </a>
                <a href="https://drive.google.com/file/d/1QW2p06boHXRGjXUbkwvHRn8Qha9kBF6t/view?usp=sharing" target="_blank"
								rel="external noopener noreferrer" class="py-3 px-5 sm:ms-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    Learn more
										<svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                    </svg>
