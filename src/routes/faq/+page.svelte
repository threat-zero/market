<script lang="ts">
	import { AccordionItem, Accordion, AccordionHeader, AccordionContent } from "flowbite-svelte";
...
<section class="bg-white dark:bg-gray-900">
	<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
		...
		<Accordion>
  		<AccordionItem>
    		<AccordionHeader>Where is the zero-trust boundary  enforced?</AccordionHeader>
  		...
  		<AccordionItem>
    		<AccordionHeader>How light is “lightweight”?</AccordionHeader>
    		<p class="mb-2 text-gray-500 dark:text-gray-400">Less than 60MB on disk, 30MB in memory, 0.1% cpu.</p>
  		</AccordionItem>
			<AccordionItem>
    		<AccordionHeader>Where does the “brain” reside?</AccordionHeader>
			...
			<AccordionItem>
    		<AccordionHeader>Can I write policies against arbitrary  groupings of devices?</AccordionHeader>
			...
			<AccordionItem>
    		<AccordionHeader>What are the Active Directory  systems you support?</AccordionHeader>
    		<p class="mb-2 text-gray-500 dark:text-gray-400">We support any ID authentication  method: AD, Azure AD (Entra),Google,  AWS, Ping, Octa, Social, etc. We also  support hybrid schemes.</p>
  		</AccordionItem>
			<AccordionItem>
    		<AccordionHeader>How fast can my zero-trust security  posture be changed?</AccordionHeader>
			...
			<AccordionItem>
    		<AccordionHeader>What if I need to block an app but  only for a specific group of my users?</AccordionHeader>
			...
			<AccordionItem>
    		<AccordionHeader>I need to control exactly which can  communicate with my servers and  workloads. Can I achieve that?</AccordionHeader>
    		<p class="mb-2 text-gray-500 dark:text-gray-400">You sure can! When you write policies  in the “ingress” direction, you’ll have  the peace of mind that only expressly  authorized access is permitted.</p>
  		</AccordionItem>
			<AccordionItem>
    		<AccordionHeader>My network suffers because of  uncontrolled software updates. Can  ThreatMatic control that? </AccordionHeader>
			...
			<AccordionItem>
    		<AccordionHeader>Can you block traffic to known  malicious sites?</AccordionHeader>
			...
			<AccordionItem>
    		<AccordionHeader>How fast can I securely connect my  employees to data centers and public  cloud subscriptions?</AccordionHeader>
			...
			<AccordionItem>
				<AccordionHeader>How can I reign in my Public Cloud  spending?</AccordionHeader>
			...
			<AccordionItem>
				<AccordionHeader>What are some of the use-cases?</AccordionHeader>
			...
			<AccordionItem>
				<AccordionHeader>How fast can I test Threatmatic in my own environment?</AccordionHeader>
